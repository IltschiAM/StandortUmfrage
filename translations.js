const translations = {
  ...
  en: {
    ...
    statisticsLabel: "Total participants:",
    alertKeinName: "Please enter a player name first.",
    alertKeineSpiele: "Please select a game.",
    msgWarten: "Please wait, a saving is already in progress.",
  ...
  fr: {
    ...
    statisticsLabel: "Total des participants:",
    alertKeinName: "Veuillez d'abord entrer un nom de joueur.",
    alertKeineSpiele: "Veuillez choisir un jeu.",
    msgWarten: "Veuillez patienter, une sauvegarde est déjà en cours.",
    ...
    viewonly_label: "mode consultation"
  }
};
